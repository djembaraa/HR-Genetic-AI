...
function App() {
  ...
  return (
    <>
      ...
      {view === 'dashboard' && (
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', paddingTop: '6rem' }}>
          <main className="animate-fade-in" style={{ padding: '2rem 5%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', flexGrow: 1 }} role="main">
            
            <Card>
              <h2 style={{ marginBottom: '1.5rem' }}>Candidate Data</h2>
              <p className="subtitle">Database records from Express & Prisma will appear here.</p>
              <div style={{ background: '#fafafa', padding: '1.5rem', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                <h4>Mock Candidate Extracted</h4>
                <p style={{ color: 'var(--text-light)', marginTop: '0.5rem' }}>Vector embeddings are stored in ChromaDB and ready to be queried.</p>
              </div>
            </Card>
